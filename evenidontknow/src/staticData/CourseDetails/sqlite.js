export const sqlite = {
  ...
  title: "Understanding Android SQLite.",
  sections: [
    {
      type: "section",
      contents: [
        {
          type: "paragraph",
          content:
            'SQLite is a relational database, containing tables and indexes. SQLite is one of the worlds most widely deployed database engines. Many think the term "Lite" refers to its capabilities. However, the actual meaning is it is lightweight, so it is called SQLite. SQLite does not require a server to operate. The SQLite library accesses its storage files directly.'
        },
        {
          type: "h3",
          content: "Why not sharedPreferences?"
        },
        {
          type: "paragraph",
          content:
